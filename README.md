...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/offlineimap-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/offlineimap-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add offlineimap
# for installing globally
pixi global install offlineimap
```
...
It is possible to list all of the versions of `offlineimap` available on your platform:
...
```
pixi search offlineimap --channel conda-forge
```
